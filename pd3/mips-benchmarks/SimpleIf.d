...
SimpleIf.elf:     file format elf32-tradbigmips
...
8002001c:	28420005 	slti	v0,v0,5
80020020:	10400007 	beqz	v0,80020040 <main+0x40>
80020024:	00000000 	nop
80020028:	8fa30008 	lw	v1,8(sp)
8002002c:	8fa2000c 	lw	v0,12(sp)
80020030:	00621021 	addu	v0,v1,v0
80020034:	afa20008 	sw	v0,8(sp)
80020038:	10000005 	b	80020050 <main+0x50>
8002003c:	00000000 	nop
80020040:	8fa30008 	lw	v1,8(sp)
80020044:	8fa2000c 	lw	v0,12(sp)
80020048:	00621023 	subu	v0,v1,v0
8002004c:	afa20008 	sw	v0,8(sp)
80020050:	8fa30008 	lw	v1,8(sp)
80020054:	8fa2000c 	lw	v0,12(sp)
80020058:	00621021 	addu	v0,v1,v0
8002005c:	afa20010 	sw	v0,16(sp)
80020060:	8fa20010 	lw	v0,16(sp)
80020064:	27bd0018 	addiu	sp,sp,24
80020068:	03e00008 	jr	ra
8002006c:	00000000 	nop

Disassembly of section .reginfo:

80020070 <.reginfo>:
80020070:	a000000c 	sb	zero,12(zero)
	...

Disassembly of section .MIPS.abiflags:

80020088 <.MIPS.abiflags>:
80020088:	00002001 	movf	a0,zero,$fcc0
8002008c:	01010001 	movt	zero,t0,$fcc0
	...
80020098:	00000001 	movf	zero,zero,$fcc0
